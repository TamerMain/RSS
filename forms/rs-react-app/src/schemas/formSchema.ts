...
type Countries = typeof countryList;

export const createFormSchema = (countryList: Countries) => {
  return z
    .object({
      name: z
        .string()
...
export type EntryFormData = z.infer<ReturnType<typeof createFormSchema>>;
