...
function ThemeButton() {
  ...
  return (
    <button
      ...
      className={`relative m-auto w-16 h-8 mb-4 border-2 border-transparent light:border-mist-800 ${context.isDark ? 'bg-mist-800' : 'bg-mist-50'} transition-colors duration-800`}
    >
      <span
